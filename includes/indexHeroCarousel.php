            <link rel="stylesheet" href="./static/css/indexHeroCarousel.css">

            <div id="carousel-Hero" class="carousel slide" data-bs-ride="carousel" data-bs-pause="true">
                ...
                <div class="carousel-inner">
                    ...
                    <!-- Slide 2 -->
                    <div class="carousel-item c-slide" data-bs-interval="7000">
                        <div class="slide-content">
                            <div class="s-content-inner">
                                <div class="s-plans-heading p-2">
                                    <h1 class="hero-slide2-head">BUSINESS EMAILS</h1>
                                    <h3>Easy to use and secure! </h3>
                                </div>
                                <div class="row s2-plans">
                                    <div class="col-6 col-md-4 mail p-1">
                                        <div class="mail-box">
                                            <div class="mail-img"></div>
                                            <div class="mail-txt">
                                                <p style="padding: 5px; text-align: center;">
                                                    Suitable for individual professionals and small businesses.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-4 mail p-1">
                                        <div class="mail-box">
                                            ...
                                            <div class="mail-txt">
                                            <p style="padding: 5px; text-align: center;">
                                                Take a step further with additional features that advance your email experience.
                                            </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="carousel-item c-slide" data-bs-interval="7000">
                        <div class="slide-content">
                            <div class="row s-content-inner col-12">
                                <div class="col-md-5 hero-texts">
                                    <h1>VSAT BROADBAND INTERNET</h1>
                                    <h3>Suitable for Remote Locations</h3>
                                </div>
                                <div class="col-md-7 hero-plans">
                                </div>
                            </div>
                        </div>
                    </div>
